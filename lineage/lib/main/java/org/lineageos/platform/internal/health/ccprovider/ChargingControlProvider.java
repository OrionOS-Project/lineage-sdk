...
public abstract class ChargingControlProvider {
    ...
    /**
     * Called when the mode is {@link orionos.health.HealthInterface#MODE_LIMIT} and
    ...
    /**
     * Called when the mode is {@link orionos.health.HealthInterface#MODE_AUTO} or
     * {@link orionos.health.HealthInterface#MODE_MANUAL} and the
     ...
     *                   {@link orionos.health.HealthInterface#MODE_AUTO} or
