...
public class Build {
    ...
    public static final String ORION_VERSION = getString("ro.orion.version");

    /** A build ID string meant for displaying to the user */
    public static final String ORION_DISPLAY_VERSION = getString("ro.orion.display.version");
